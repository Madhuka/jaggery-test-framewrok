var cola = (function () {
     ...
     */
    var run = function () {
        //log.debug(request.getContentType() + 'Called the run for -------' + request.getHeader("User-Agent")+':');
     ...
     *
     * http://localhost:9763/automobileapp/test[/{folderName}0-n][/{fileName}0-1][/{
