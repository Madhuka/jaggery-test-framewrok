var cola = (function() {
	...
	jasmine.Spec.prototype.runs = function(func) {
		var block = new jasmine.Block(this.env, func, this), spec = specifcation;
	...
	var crawl = function(root) {
		...
		var file = new File(root), list = file.listFiles();
	...
	var isValidPath = function(path1, path2) {
		var isValid = false;
		if ((isDirectory(path2) || isExists(path2 + TEST_FILE_EXTENSIOIN))
				&& !(isDirectory(path1) || isExists(path1
						+ TEST_FILE_EXTENSIOIN))) {
